			...
			if (incompatibleProposals.length === 1) {
				notices.push(
					nls.localize(
						...
						"This extension is using the API proposal '{0}' that is not compatible with the current version of Architech.",
				...
				notices.push(
					nls.localize(
						...
						"This extension is using the API proposals {0} and '{1}' that are not compatible with the current version of Architech.",
