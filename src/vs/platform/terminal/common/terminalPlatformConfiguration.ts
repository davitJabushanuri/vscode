	...
	properties: {
		...
		[TerminalSettingId.InheritEnv]: {
			...
			description: localize(
				...
				"Whether new shells should inherit their environment from Architech, which may source a login shell to ensure $PATH and other development variables are initialized. This has no effect on Windows."
			),
			type: "boolean",
			default: true,
		},
