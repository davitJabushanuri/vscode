...
const CopilotSignedOutButton = Button(
	localize("setupCopilotButton.signIn", "Set up Copilot"),
	`command:workbench.action.chat.triggerSetup`
);
const CopilotSignedInButton = Button(
	localize("setupCopilotButton.setup", "Set up Copilot"),
	`command:workbench.action.chat.triggerSetup`
);
const CopilotCompleteButton = Button(
	localize("setupCopilotButton.chatWithCopilot", "Chat with Copilot"),
...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		id: "Setup",
		title: localize("gettingStarted.setup.title", "Get started with Architech"),
		description: localize(
		...
		content: {
			...
			steps: [
				...
				createCopilotSetupStep(
					...
					"chatSetupInstalled && !chatSetupDisabled && (chatPlanPro || chatPlanProPlus || chatPlanBusiness || chatPlanEnterprise || chatPlanFree)",
					false
				),
				createCopilotSetupStep(
					"CopilotSetupSignedIn",
					CopilotSignedInButton,
					"!chatEntitlementSignedOut && (!chatSetupInstalled || chatSetupDisabled || chatPlanCanSignUp)",
					true
				),
				{
					id: "pickColorTheme",
				...
				},
				{
					...
					description: localize(
						...
						"Extensions are Architech's power-ups. A growing number are becoming available in the web.\n{0}",
						Button(
							localize("browsePopularWeb", "Browse Popular Web Extensions"),
					...
					media: {
						type: "svg",
						altText:
							"Architech extension marketplace with featured language extensions",
				...
				},
				{
					...
					description: localize(
						...
						Button(
							localize("browseLangExts", "Browse Language Extensions"),
				...
				// },
				{
					...
					description: localize(
						...
						"Customize every aspect of Architech and your extensions to your liking. [Back up and sync](command:workbench.userDataSync.actions.turnOn) your essential customizations across all your devices.\n{0}",
						Button(
				...
				},
				{
					...
					description: localize(
						...
						"Run commands without reaching for your mouse to accomplish any task in Architech.\n{0}",
						Button(
				...
				},
				{
					...
					description: localize(
						...
						"Watch the first in a series of short & practical video tutorials for Architech's key features.\n{0}",
						Button(
...

	{
		...
		title: localize(
			...
			"Get Started with Architech for the Web"
		),
		description: localize(
		...
		content: {
			...
			steps: [
				...
				},
				{
					...
					description: localize(
						"gettingStarted.extensionsWebWeb.description.interpolated",
						"Extensions are Architech's power-ups. A growing number are becoming available in the web.\n{0}",
						Button(
							localize("browsePopularWeb", "Browse Popular Web Extensions"),
							"command:workbench.extensions.action.showPopularExtensions"
				...
				},
				{
					...
					description: localize(
						"gettingStarted.commandPaletteWeb.description.interpolated",
						"Run commands without reaching for your mouse to accomplish any task in Architech.\n{0}",
						Button(
							localize("commandPalette", "Open Command Palette"),
							"command:workbench.action.showCommands"
				...
				},
				{
					...
					description: localize(
						...
						"You're all set to start coding. You can open a local project or a remote repository to get your files into Architech.\n{0}\n{1}",
						Button(
			...
			steps: [
				{
					...
					description: localize(
						...
						Button(
							localize("openAccessibilityHelp", "Open Accessibility Help"),
				...
				},
				{
					...
					description: localize(
						...
						Button(
							localize("openAccessibleView", "Open Accessible View"),
				...
				},
				{
					...
					description: localize(
						...
						Button(
							localize("openVerbositySettings", "Open Accessibility Settings"),
				...
				},
				{
					...
					description: localize(
						...
						Button(
							localize("listSignalAnnouncements", "List Signal Announcements"),
				...
				},
				{
					...
					description: localize(
						...
						Button(
							localize("toggleFoldRecursively", "Toggle Fold Recursively"),
				...
				},
				{
					...
					description: localize(
						...
						Button(
							localize("triggerIntellisense", "Trigger Intellisense"),
							"command:editor.action.triggerSuggest"
						),
						Button(
							localize("triggerInlineSuggestion", "Trigger Inline Suggestion"),
			...
			steps: [
				{
					...
					description: localize(
						...
						Button(
							localize("browsePopular", "Browse Popular Extensions"),
							"command:workbench.extensions.action.showPopularExtensions"
						)
					),
					when: "workspacePlatform != 'webworker'",
				...
				},
				{
					...
					description: localize(
						...
						Button(
							...
							"command:toSide:workbench.trust.manage"
						)
					),
	...
	},
	{
		...
		title: localize("gettingStarted.new.title", "Get started with Architech"),
		description: localize(
			"gettingStarted.new.description",
		...
		when: "!isWeb",
		walkthroughPageTitle: localize(
			"gettingStarted.new.walkthroughPageTitle",
			"Set up VS Code"
		),
		content: {
			type: "steps",
			steps: [
				{
					...
					description: localize(
						"gettingStarted.agentMode.description",
				...
				},
				{
					...
					description: localize(
						"gettingStarted.nes.description",
						"Get code suggestions that predict your next edit."
					),
					media: {
						type: "svg",
						altText: "Next edit suggestions",
						path: "ai-powered-suggestions.svg",
					},
				},
				{
					id: "copilotSetup.customize",
					title: localize(
						"gettingStarted.customize.title",
						"Personalized to how you work"
					),
					description: localize(
						"gettingStarted.customize.description",
						"Swap models, add agent mode tools, and create personalized instructions.\n{0}",
						Button(
							localize("signUp", "Enable AI features"),
							"command:workbench.action.chat.triggerSetupWithoutDialog"
						)
					),
					media: {
						type: "svg",
						altText: "Personalize",
						path: "customize-ai.svg",
					},
				},
				{
					id: "newCommandPaletteTask",
					title: localize(
						"newgettingStarted.commandPalette.title",
				...
				},
				{
					...
					title: localize(
						"newgettingStarted.findLanguageExts.title",
						"Support for all languages"
					),
					description: localize(
						"newgettingStarted.findLanguageExts.description.interpolated",
